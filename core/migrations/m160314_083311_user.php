...
class m160314_083311_user extends Migration {
    ...
    public function up() {
        ...
        $this->createTable('{{%user}}', [
            ...
            'login_code' => Schema::TYPE_STRING . '(6) null default null',
            'folder' => Schema::TYPE_STRING . ' null default null',
                ], $tableOptions);
        ...
        $this->createTable('{{%profile}}', [
            ...
            'postalـcode' => Schema::TYPE_STRING . ' null default null',
            'national_code' => Schema::TYPE_STRING . ' null default null',
